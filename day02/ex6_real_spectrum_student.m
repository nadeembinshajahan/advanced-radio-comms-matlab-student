...
%  Exercise  : 6 - Read the real spectrum   *** STUDENT STARTER FILE ***
...
%              tuned to. This one idea - the two-sided spectrum on an
%              absolute frequency axis - is used on every later day.
%  Run time  : about 45 minutes.
%  Needs     : plain MATLAB (MATLAB Online is fine). No toolbox.
%              Plus the capture file  fm_capture_98MHz.mat  and, for
%              Sections 10 and 11,  fm_capture_98MHz_lowgain.mat.
%              Upload BOTH files before you start.
%  TIER      : Sections 1, 2, 4, 5, 7, 8, 9 are TYPE ALONG - fill in
%              every YOUR CODE HERE gap.
%              Sections 3, 6, 10, 11 are RUN AND SEE - they are already
...
%  The trainer has an ADALM-Pluto. Before class it was tuned to 98 MHz,
%  the middle of the FM broadcast band, and told to record 2 million
%  samples per second for a small fraction of a second. That recording
%  is the file you are about to open. It is real radio, not a formula.
% ====================================================================

%% Section 1 (TYPE ALONG) - open the capture and see what is inside it
clear; clc;
load('fm_capture_98MHz.mat');   % gives iq, fs, fc, gain_dB, capture_time, source
...
c = 3e8;                        % speed of light, as in Day 1 Exercise 2
% GAP 6: what is the wavelength of that station, and a quarter of it?
% Hint: same formula as Day 1 Exercise 2. Both are single numbers, so
%       plain / is fine here - you do not need ./ this time.
...
% Straight back to Day 1 Exercise 1: a difference in dB is a ratio in power.
...
%       you did in Day 1 Exercise 1: 10^(difference/10).
